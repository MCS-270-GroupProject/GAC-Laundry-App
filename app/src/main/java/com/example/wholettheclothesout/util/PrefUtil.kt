...
import com.example.wholettheclothesout.PittmanActivity
...
class PrefUtil {
    companion object{
        ...
        fun getTimerState(context: Context): PittmanActivity.TimerState{
            val preferences = PreferenceManager.getDefaultSharedPreferences(context)
            val ordinal = preferences.getInt(TIMER_STATE_ID,0)
            return PittmanActivity.TimerState.values()[ordinal]
        }

        fun setTimerState(state: PittmanActivity.TimerState, context: Context){
            val editor = PreferenceManager.getDefaultSharedPreferences(context).edit()
